...
void setup() {
  ...
  gsm.begin(9600);
  dht.begin();
  pinMode(FOTORESISTENZA_PARCHEGGIO_0, INPUT);
  pinMode(FOTORESISTENZA_PARCHEGGIO_1, INPUT);
  pinMode(FOTORESISTENZA_PARCHEGGIO_2, INPUT);
  pinMode(FOTORESISTENZA_PARCHEGGIO_3, INPUT);
  pinMode(FOTORESISTENZA_INTERNO, INPUT);
  pinMode(FOTORESISTENZA_ESTERNO, INPUT);
  pinMode(FOTORESISTENZA_LUMINOSITA INPUT);
  pinMode(LAMPEGGIANTE, OUTPUT);
  pinMode(SEMAFORO_R, OUTPUT);
  pinMode(SEMAFORO_G, OUTPUT);
  pinMode(LAMPIONI, OUTPUT);
  pinMode(FINE_CORSA_APERTURA, INPUT);
  pinMode(FINE_CORSA_CHIUSURA, INPUT);
  pinMode(PULSANTE_INTERNO, INPUT);
  pinMode(PULSANTE_TASTIERA, INPUT);
  pinMode(PULSANTE_IMPRONTA, INPUT);
  pinMode(LASER_PARCHEGGIO_0, OUTPUT);
  pinMode(LASER_PARCHEGGIO_1, OUTPUT);
  pinMode(LASER_PARCHEGGIO_2, OUTPUT);
  pinMode(LASER_PARCHEGGIO_3, OUTPUT);
  pinMode(LASER_INTERNO, OUTPUT);
  pinMode(LASER_ESTERNO, OUTPUT);
  pinMode(LED_R_PARCHEGGIO_0, OUTPUT);
  pinMode(LED_G_PARCHEGGIO_0, OUTPUT);
  pinMode(LED_R_PARCHEGGIO_1, OUTPUT);
  pinMode(LED_G_PARCHEGGIO_1, OUTPUT);
  pinMode(LED_R_PARCHEGGIO_2, OUTPUT);
  pinMode(LED_G_PARCHEGGIO_2, OUTPUT);
  pinMode(LED_R_PARCHEGGIO_3, OUTPUT);
  pinMode(LED_G_PARCHEGGIO_3, OUTPUT);
